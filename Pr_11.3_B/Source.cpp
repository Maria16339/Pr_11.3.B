...
enum Specialty { ITIS, RE, KN, KI, PZ };

string strSpecialty[] = { "Інформатика ",
...
int fkurs(fstream& f, const int i);
...
void Create(char* FileName)
{
    ...
    do {
        ...
        do
        {
            cout << "Спеціальність (0-ITIS, 1-RE, 2-KN, 3-KI, 4-PZ ): "; cin >> specialty;
